...
# Wed Jan 27 14:41:26 PST 2016
# DO NOT MODIFY


# 
# frame_arbiter "frame_arbiter" v1.0
# Cory Barney 2016.01.27.14:41:25
# 
# 
...
add_fileset_file framebuffer_arbiter.v VERILOG PATH framebuffer_arbiter.v TOP_LEVEL_FILE
...
# 
add_interface out0 conduit end
set_interface_property out0 associatedClock clock
set_interface_property out0 associatedReset ""
...
add_interface_port out0 read_clk readclk Input 1
add_interface_port out0 aso_out0_readdata readdata Output 16
